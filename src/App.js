  ...
  const sections = [
    {
      ...
      benefits: [
        ...
        "Usage Statistics",
        "Communication with Child and Teachers",
        "Time Management – School Time, Bedtime, Playtime",
      ],
    },
    {
      title: "Teacher",
      benefits: [
        ...
        "Assigning & Re-Assigning Tasks to students possible",
        "Communication with Parents & Childs",
        "Dashboard",
      ],
    },
    {
      ...
      benefits: [
        "School on Digital space",
        "Customized Reports",
        "Teacher & Student progress overview",
        "Study materials based on curriculum",
        "Dedicated login",
    ...
    },
    {
      title: "Student",
      benefits: [
        "Dedicated App/Web login",
        "Readers (Physical)",
        "eBooks",
        "Synopses for revision",
        "Digital Worksheets",
        "Hints",
        "Self-Learning tools",
        "Communication with Teacher & Parent",
        "Explanations and solutions to questions",
      ],
    },
  ];
    ...
    <div>
      <Parallax pages={11}>
        ...
        <ParallaxLayer offset={3} speed={0.5}>
          <div className="section section3">
            <Typography variant="h3" align="center" gutterBottom>
              This is Learnplay School, Parental Control and Educational
              analytics
            </Typography>
          </div>
        </ParallaxLayer>
        ...
        <ParallaxLayer offset={4} speed={0.5}>
          <div className="section section3">
            ...
            sagittis tellus, nec ultricies diam. Mauris tincidunt nulla eget
            pulvinar feugiat. Quisque blandit orci lorem, ac fermentum ipsum
            sodales at. Nullam a nisi non velit fermentum pharetra. Vestibulum
            gravida venenatis dui, eu tempus tellus tempor velom
          </div>
        </ParallaxLayer>
